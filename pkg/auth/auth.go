...
import (
	...
	yamlUtils "github.com/suomitek/suomitek-appboard/pkg/yaml"
...
func NewAuth(token string) (*UserAuth, error) {
	...
	config.BearerTokenFile = "" // https://github.com/suomitek/suomitek-appboard/pull/1359#issuecomment-564077326
